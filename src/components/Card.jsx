...
const Card = ({ title, description, image, link }) => {
  ...
  return (
    <div className="glass-effect relative shadow-lg hover-scale flex flex-col lg:flex-row rounded-md overflow-hidden h-full min-h-[250px] ">
      {/* Image Block */}
      <div className="w-full lg:w-1/2 h-60 lg:h-auto">
        <img
          src={image}
          alt={title}
