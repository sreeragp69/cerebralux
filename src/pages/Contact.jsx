...
const Contact = () => {
  return (
    <section
      ...
      className="pb-20 pt-10 px-4 bg-[hsl(var(--background))] fade-in"
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <div className="glass-effect  p-5 md:p-8 rounded-xl">
            ...
            <p className="text-white/90 text-sma mb-6">
              Ready to make a global impact? Ask about our personal branding,
              PR, and production packages.
            </p>
            <button className="w-full mb-6 bg-white/10 text-white hover:bg-white/20 border border-white/20 hover-scale">
